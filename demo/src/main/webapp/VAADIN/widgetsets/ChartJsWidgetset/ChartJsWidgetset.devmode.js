...
var __gwtModuleFunction = $wnd.ChartJsWidgetset;
var $sendStats = __gwtModuleFunction.__sendStats;
$sendStats('moduleStartup', 'moduleEvalStart');
var $gwt_version = "7.6.8";
var $strongName = '';
var $gwt = {};
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.ChartJsWidgetset=");
    idx += (13 + "ChartJsWidgetset".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=ChartJsWidgetset-0.js
